...
def scrape_line():
    ...
    result_list_raw=soup.select("#__next > div.layout__wrapper > main > article > article > div.zodiac_container__T9OXy > div > a > div.zodiac-item_content__hOFiF > span.zodiac-item_name__c4Ypu")
...
def scrape_docomo():
    ...
    #print(soup_docomo)
    result_list_top3_raw=soup.select("body > div.postRank.-bdb.-ico01 > div > div.postRank__list > div > div.postRank__info > div.postRank__infoHead > div.postRank__infoHeadTtl > h3 ")
    result_list_4th_raw=soup.select("body > div.postRank.-bdb.-ico01 > div > div.rankTggl > div.toggle-content > div > div > div.postRank__info > div.postRank__infoHead > div.postRank__infoHeadTtl > h3")
...
def main():
    ...
    average=round((line_dict[zodiac]+docomo_dict[zodiac]+asahi_dict[zodiac])/3,2)
